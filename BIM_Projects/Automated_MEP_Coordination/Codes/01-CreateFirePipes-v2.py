# -----------------------------------------------------------
# Project: P1 – Port Area Automated MEP Coordination
# Script: P1_create_fire_protection_pipes_from_csv.py
# Author: Anıl Bayburtluoğlu
# Description:
#   This script automates the creation and coordination of fire protection
#   pipes in a Revit model based on CSV files generated from a 
#   Grasshopper parametric workflow.
#
#   It includes:
#     - Deleting previously placed pipes/fittings/sprinklers
#     - Creating horizontal pipes based on CSV geometry
#     - Creating vertical risers and connectors
#     - Assigning system types, diameters, and ceiling height metadata
#     - Creating upright and pendent sprinklers dynamically
#     - Organizing elevations to avoid clashes
#
# Dependencies:
#   - RevitPythonShell or pyRevit environment
#   - Required Revit families must exist (Pipe Types, Sprinkler Symbols)
#   - The Revit file must contain Level "L05"
#
# CSV Example (L05-Curves.csv):
#   StartX,StartY,StartZ,EndX,EndY,EndZ,SystemName,ZONE,Critical
#
# Last Updated: 2025-04-14
# -----------------------------------------------------------

# --- configuration -------------------------------------------------
# Point this to the folder holding the exported CSV data for the zone.
DATA_DIR = r"C:\ScriptCSV"
# -------------------------------------------------------------------
...
# === DELETE EXISTING ELEMENTS FROM TARGET LEVEL ===
...
# === RESET 'isOrganized' PARAMETER FOR ALL SPRINKLERS ===
...
# === CREATE HORIZONTAL PIPES FROM CSV ===
...
# === DELETE DUPLICATE PIPES BASED ON GEOMETRY ===
...
# === DELETE UNNECCESARY EXTRA PIPES ===
...
# === GET INTERSECTION POINTS OF PIPE CURVES ===
...
# === CREATE PIPES FROM CSV WHICH HAS TAGS ===
...
# === ORGANIZE SECONDARY PIPES OF SPRINKLERS ===
...
# === GET CEILING ELEMENTS FROM LINKED MODELS ===
...
# === CEILING HEIGHT OF RELATED PIPE ===
...
# === GET PIPE LENGTHS TO PUT ON PARAMETERS ===
...
# Step 1: Delete existing pipes and fittings from Level L05
...
# Step 2: Reset sprinkler organization state
...
t = Transaction(doc, "ORGANISE SPRİNKLER")
t.Start()
